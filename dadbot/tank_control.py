# Adapted from https://github.com/jhiggason/yahboomg1tank/blob/main/src/tank_control_pkg/tank_control_pkg/tank_control.py
...
class TankControl(Node):
    ...
    def __init__(self):
        ...
        try:
            self.config = self.load_yaml_config(os.path.join(
